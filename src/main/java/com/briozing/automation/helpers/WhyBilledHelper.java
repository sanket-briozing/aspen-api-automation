...
public class WhyBilledHelper {
    private RequestSpecification requestSpecification;

    public WhyBilledHelper() {
    ...
    public Response enterWhyBilled(WelcomeRequestVO welcomeRequestVO, int status) {
        final Response response = given(requestSpecification)
                .header("Content-Type", "application/json")
    ...
    public Response foundWhatLookingForButtonClick(WelcomeRequestVO welcomeRequestVO, int status) {
        final Response response = given(requestSpecification)
                .header("Content-Type", "application/json")
                .header("sessionId",TestConstants.sessionId)
                .body(welcomeRequestVO)
    ...
    public Response contactCustomerServiceButtonClick(WelcomeRequestVO welcomeRequestVO, int status) {
        final Response response = given(requestSpecification)
                .header("Content-Type", "application/json")
                .header("sessionId",TestConstants.sessionId)
                .body(welcomeRequestVO)
